...
function Navbar({ search, setSearch, setShowSaved }) {
  ...
  const handleCreateBlog = () => {
    ...
    if (!username) {
      // Guest user: generate guestId if not already present
